...
class PacienteController extends Controller
{
    ...
    {
        //chamando a tela para o cadastro dos pacientes
    ...
    public function store(Request $request)
    {
        ...
        //executando o metodo para a gravação do registro
        $paciente = Paciente::create($validateData);
        //redirecionando para a tela principal do modulo de pacientes
